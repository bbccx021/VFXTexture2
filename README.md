...
| **動態預覽**(選用) | 預設關閉、預覽為靜態。勾選「▶ 動態」可讓貼圖像在引擎裡一樣動起來:依特效自動選動畫(火焰閃爍/拖尾流動/傳送門旋轉/打擊爆發/星芒閃耀/脈動),也可手動指定模式 |
...
| 分類 | 範本 |
|---|---|
| 打擊 / 衝擊 | 💢 碎裂衝擊 Impact · 🎯 圓形撞擊 Circle Impact · 💥 打擊爆閃 Hit Burst · ⭕ 環狀衝擊波 Shockwave |
...
| 元素 / 自然 | 🔮 能量球 Plasma · ✨ 星芒閃光 Sparkle · 🟡 光塵散景 Bokeh · 🎆 煙花綻放 Firework · 🌀 傳送門 Portal · 💧 水花 Water · ❄ 冰晶 Frost · ☣ 毒液氣泡 Toxic |
| 表面 / 氛圍 | 🕸 裂縫 Cracks · 🪨 地裂 Ground Cracks · 🌫 煙霧 Smoke |
