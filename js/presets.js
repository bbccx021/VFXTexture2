  ...
  const SPECS = {
    ...
    fire: {
      nodes: [
        ...
        ['grad', 'gradientMap', 880, 130, { preset: 'fire' }],
    ...
    lightning: {
      nodes: [
        ...
        ['grad', 'gradientMap', 880, 130, { preset: 'electric' }],
    ...
    burst: {
      nodes: [
        ...
        ['grad', 'gradientMap', 670, 130, { preset: 'gold' }],
    ...
    magic: {
      nodes: [
        ...
        ['grad', 'gradientMap', 880, 200, { preset: 'arcane' }],
    ...
    stylizedTrail: {
      nodes: [
        ...
        ['grad', 'gradientMap', 990, 220, { preset: 'ice' }],
        ['out', 'output', 1180, 220],
      ],
      links: [
        ['band', 'bandT'], ['nz', 'nstr'],
    ...
    lens: {
      nodes: [
        ...
        ['grad', 'gradientMap', 1180, 340, { preset: 'ice' }],
    ...
    cracks: {
      nodes: [
        ...
        ['grad', 'gradientMap', 800, 220, { preset: 'ember' }],
    ...
    muzzle: {
      nodes: [
        ...
        ['grad', 'gradientMap', 800, 220, { preset: 'gold' }],
    ...
    slash: {
      nodes: [
        ...
        ['grad', 'gradientMap', 1560, 300, { preset: 'ice' }],
    ...
    circleImpact: {
      nodes: [
        ...
        ['grad', 'gradientMap', 1180, 300, { preset: 'gold' }],
    ...
    groundSlash: {
      nodes: [
        ...
        ['grad', 'gradientMap', 1560, 300, { preset: 'ember' }],
    ...
    fireball: {
      nodes: [
        ...
        ['grad', 'gradientMap', 800, 130, { preset: 'fire' }],
    ...
    groundCrack: {
      nodes: [
        ...
        ['grad', 'gradientMap', 1750, 130, { preset: 'fire' }],
