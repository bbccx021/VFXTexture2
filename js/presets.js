  ...
  const SPECS = {
    ...
    celTrail: {
      nodes: [
        ...
        ['cs', 'crossProfile', 444, -54, { row: 0.44, style: 'line', scale: 0.57, base: 0.14, lineW: 24, soft: 19.5 }],
        ['sc', 'histogramScan', 698, -61, { pos: 0.08, contrast: 1 }],
        // 咬邊:寬扁圓(sizeX 2.57)+ 反轉遮罩 → 從線條外緣啃入
        ['bites', 'tileSampler', 743, 158, { pattern: 'disc', count: 8, size: 1, sizeX: 2.57, sizeY: 1.19, sizeRand: 0.62, posRand: 0.96, briRand: 0, coverage: 0.53, maskThreshold: 0.28, maskInvert: true, seed: 9473 }],
        ['erode', 'blend', 993, -3, { mode: 'sub' }],
      ...
      macros: [
        ...
        { label: '斑塊侵蝕', def: 1, targets: [['xsub', 'opacity', 0, 1]] },
      ],
    },
