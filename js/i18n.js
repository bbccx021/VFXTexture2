...
const I18N_EN = {
  ...
  '等高線 — 從灰階提取等高線亮帶(閃電/拖尾)': 'Contour bands — extract iso-lines from grayscale',
  ...
  '遮罩重映射 — 把柔和漸層掃成高對比硬邊輪廓': 'Mask remap — scan soft gradients into hard silhouettes',
  ...
  '亮度選帶 — 只保留某段灰階並拉伸回滿幅,挑亮度層做遮罩': 'Band select — isolate a gray range and restretch',
  ...
  /* ---- 巨集滑桿標籤 ---- */
  '大小(整體)': 'Size (overall)', '橫向大小 ×': 'Size X ×', '縱向大小 ×': 'Size Y ×',
  '邊緣柔度': 'Edge Soft', '閾值': 'Threshold', '比較': 'Compare',
  '邊緣暈開': 'Edge Bleed', '有機擾動': 'Organic Wobble', '外圈亮線': 'Rim Line',
  '波紋起伏': 'Wave Motion', '線條圓潤': 'Line Rounding',
  '方向拉伸': 'Directional Stretch', '拖尾方向': 'Trail Angle', '銳利細節': 'Sharp Detail', '形狀微調': 'Shape Tweak',
  '裂紋密度': 'Crack Density', '裂紋粗細': 'Crack Width', '扭曲不規則': 'Warp Irregular',
  '隨機侵蝕': 'Random Erosion', '高光發光': 'Highlight Glow', '熱力發光': 'Heat Glow',
  '火舌數量': 'Tongue Count', '火舌扭曲': 'Tongue Twist', '內部尖角': 'Inner Spikes', '溫度階層': 'Heat Tiers',
  '邊緣扭曲': 'Edge Distort', '放射發光': 'Radial Glow',
  '彎曲起伏': 'Curve Sway', '咬邊鏤空': 'Bite Cutouts', '內部沖蝕': 'Inner Erosion', '斑塊侵蝕': 'Patch Erosion',
